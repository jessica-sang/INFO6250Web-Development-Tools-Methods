...
import BananaPunchCard from './BananaPunchCard.jsx';
...
function App() {
  ...
  const handlePunch = (username) => {
    return fetchPunchBanana(username).then(response => response.count);
  };
  ...
  return (
    <div id="app">
      ...
      {state.loginStatus ? (
        <>
        <BananaPunchCard username={state.username} onPunch={handlePunch} />
